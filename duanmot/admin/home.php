                        ...
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title">SO LUONG HANG HOA</h5>
                                    <?php  $soluong = tonghanghoa();
                                        $tong = 0;
                                    ...
                                    ?>
                                    <h4 class="ad-card-title"><?php echo $tong ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title">TONG DANH MUC</h5>
                                    <?php $danhmuc = tongdanhmuc();
                                     $number = $danhmuc[0]['count(danhmuc.id)'];
                                    ?>
                                    <h4 class="ad-card-title"><?php echo $number ?> </h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                                                    <div class="revenue-info-wrap">
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td><i class="far fa-chart-bar mr-2 icon-only"></i>LUOT BAN HANG</td>
                                                                    <td>5995<sup class="medium ml-2 txt-green">+15%</sup></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><i class="fas fa-user-friends mr-2 icon-only"></i>LUONG KHACH HANG</td>
                                                                ...
                                                                <tr>
                                                                    <td><i class="fas fa-signal mr-2 icon-only"></i>GIA CA</td>
                                                                    <td>7454<sup class="medium ml-2 txt-red">+2%</sup></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><i class="far fa-heart mr-2 icon-only"></i>LUOT TUONG TAC</td>
